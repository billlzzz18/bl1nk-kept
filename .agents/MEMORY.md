...
| ARCH-002 | **คำมั่นสัญญาด้านสถาปัตยกรรม (Full FFF & SQZ Adoption - ไม่ตัดทอนว่าแค่นี้พอ):** การสร้างระบบ Context Engine ต้องนำชิ้นส่วนและแรงบันดาลใจจาก `FFF` และ `SQZ` มาใช้ให้ครบวงจร (CLI สำหรับคน, MCP สำหรับ AI, C-ABI/Library/Interceptor สำหรับ Editor, และ Polyglot Tree-sitter Grammars); ห้าม Agent คิดเองเออเองว่าทำแค่ MCP อย่างเดียวแล้วพอ | `PARTIAL` | บันทึกสถาปัตยกรรมใน `docs/specs/context_admission_engine.md`, `docs/ideas/KEPT_GRAMMARS_POLYGLOT_IDEA.md`, `docs/research/fff_architecture_report.md` | บังคับใช้ในทุกการตัดสินใจของสถาปัตยกรรม ห้ามตัดตอนหรือละเลยความต้องการของ Editor integration |
